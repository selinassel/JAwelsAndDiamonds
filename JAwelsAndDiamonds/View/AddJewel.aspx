<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Navbar.Master" AutoEventWireup="true" CodeBehind="AddJewel.aspx.cs" Inherits="JAwelsAndDiamonds.View.AddJewel" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server"> 
    ...
    <div>
       ...
       <asp:TextBox ID="jewelReleaseTxt" runat="server" TextMode="Date"/>
    </div>
