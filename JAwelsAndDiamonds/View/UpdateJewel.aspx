<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Navbar.Master" AutoEventWireup="true" CodeBehind="UpdateJewel.aspx.cs" Inherits="JAwelsAndDiamonds.View.UpdateJewel" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
       ...
       <asp:TextBox ID="jewelReleaseTxt" runat="server" placeholder="Year Only" />
    </div>
