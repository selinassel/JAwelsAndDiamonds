...
namespace JAwelsAndDiamonds.View
{
	public partial class UpdateJewel : System.Web.UI.Page
	{
        ...
        {
            var jewel = JewelRepo.GetJewelById(JewelID);
            if (jewel == null)
            {
                Response.Redirect("Home.aspx");
                return;
            ...
            jewelReleaseTxt.Text = jewel.ReleaseYear.ToString();
        }
        ...
        protected void updateBtn_Click(object sender, EventArgs e)
        {
            ...
            bool result = JewelRepo.UpdateJewel(JewelID, name, Convert.ToInt32(categoryID), Convert.ToInt32(brandID), price, releaseYear);
